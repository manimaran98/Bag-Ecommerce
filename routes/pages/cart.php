...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="assets/css/style5.css?<?php echo date('l jS \of F Y h:i:s A'); ?>">
  <meta charset="utf-8">
  <title>Home</title>
</head>
<header>
  <ul>
    ...
    <li><a><?php  if (isset($_SESSION['username'])) : ?>
                    ...
                    <?php endif ?>
    <li class="active" ><a href="<?php echo bag_url('cart'); ?>">Cart</a></li>
    <li><a href="<?php echo bag_url('trackOrder'); ?>">Track order</a></li>
    <li ><strong><a href="<?php echo bag_url('product'); ?>">Product</a></strong></li>
...
<table class="table table-bordered">  
                          ...
                          <form  action="<?php echo bag_url('trackOrder'); ?>" method="post" enctype="multipart/form-data">   
                          <tr>  <td><b><?php $count1++; echo $count1;?></b></td>
                               <td><b><?php echo $values["item_name"]; ?></td><b>
                               <td><?php echo "<img width='300' height='200' src='assets/stockImg/".$values['item_img']."'>"; ?></td>   
                               <td><?php echo $values["item_quantity"]; ?></td>  
                               <td>RM <?php echo $values["item_price"]; ?>.00</td>  
                               <td>RM <?php echo number_format($values["item_quantity"] * $values["item_price"], 2); ?></td>  
                               <td><a href="<?php echo bag_url('index', ['action' => 'delete', 'id' => $values["item_id"]]); ?>"><span class="text-danger">Remove</span></a></td>
