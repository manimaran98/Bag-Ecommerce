...
<div class="sidebar">
	<ul style="color: whitesmoke;">
		<a class="active" href="<?php echo bag_url('admin'); ?>" style="text-decoration: none; color: aliceblue;"><li>Home</li></a>
...
<td>
	<a href="<?php echo bag_url('adminEdit', ['purchase_item_id' => $row['purchase_item_id']]); ?>">Edit</a>
	<a onclick="if (!confirm('Are you sure you want to delete this Item?')) return false;" href="<?php echo bag_url('adminDelete', ['purchase_item_id' => $row['purchase_item_id']]); ?>">Delete</a>
</td>
</tr>
<?php  
