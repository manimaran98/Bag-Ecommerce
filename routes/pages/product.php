...
<header>
  <ul>
     <form id="myForm" action="<?php echo bag_url('product'); ?>"> <li><select onchange="myFunction()" id="categorySearch" name="search" title="Type in a category">
...
<br>
<?php echo "<img width='300' height='200' src='assets/stockImg/".$row['stock_img']."'>"; ?>
...
<br>
 Quantity     : <?php if ($stock==0) {
  ...
  <a class="add_cart" href="<?php echo bag_url('viewStock', ['stock_id' => $row['stock_id']]); ?>">Details</a>
...
if ($row1 > 0 ) {
    echo "<td><img src='assets/img/soon.png' width='150' height='250'><h1 style='color: #34568B;'>Coming Soon</h1></td>";
    echo "<td><img src='assets/img/soon.png' width='150' height='250'><h1 style='color: #34568B;'>Coming Soon</h1></td>";
  }
