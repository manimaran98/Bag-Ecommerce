...
<table>
	<tr>
		...
		<th style="background-color: white; border:none ;" colspan="3"><img style=" margin-left :20px; margin-top:5px; float: left;" height="80" width="120" src="assets/img/logo.png"></th>
	</tr>
	<tr>
...
RM <?php $total_price = ($stock_quantity*$stock_price); echo number_format($total_price, 2); ?>
    ...
    <td colspan="5"><input style="background-color: lightgreen; padding: 20px;" name="payment" type="button" value="Print Receipt" onclick="window.print()">
    	<input type="button" onclick="window.close();window.open('');" style="background-color:grey; padding: 20px;" value="Back" ></td>
