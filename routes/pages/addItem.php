...
<body>
<div class="header">
  <form class="form1" method="POST" action="<?php echo bag_url('addItem'); ?>" enctype="multipart/form-data">
        <?php require BAG_ROOT . '/frontend/errors.php'; ?>
