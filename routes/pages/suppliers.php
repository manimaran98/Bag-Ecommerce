...
<div class="sidebar">
	<ul style="color: whitesmoke;">
		...
		<a class="active" href="<?php echo bag_url('suppliers'); ?>" style="text-decoration: none; color: aliceblue;"><li>Suppliers</li></a>
...
<form style="text-align: right;" action="<?php echo bag_url('addSuppliers'); ?>">
...
<td>
	<a href="<?php echo bag_url('editSuppliers', ['suppliers_id' => $row['suppliers_id']]); ?>">Edit</a>
	<a onclick="if (!confirm('Are you sure you want to delete this Item?')) return false;" href="<?php echo bag_url('deleteSuppliers', ['suppliers_id' => $row['suppliers_id']]); ?>">Delete</a>
</td>
</tr>
<?php
$count++;
