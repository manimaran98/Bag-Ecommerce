...
<div class="sidebar">
	<ul style="color: whitesmoke;">
		...
		<a class="active" href="<?php echo bag_url('order'); ?>" style="text-decoration: none; color: aliceblue;"><li>Order</li></a>
...
<td>
	<a href="<?php echo bag_url('editOrder', ['delivery_id' => $row['delivery_id']]); ?>">Edit</a>
	<a onclick="if (!confirm('Are you sure you want to delete this Order?')) return false;" href="<?php echo bag_url('deleteOrder', ['delivery_id' => $row['delivery_id']]); ?>">Delete</a>
</td>
</tr>
<?php
$count++;
