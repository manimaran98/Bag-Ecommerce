...
// connect to the database
        $db = mysqli_connect('sql105.epizy.com', 'epiz_29313805', 'xA3yVeZeGpf2gNR', 'epiz_29313805_bag_biz');
...
//Admin Add Stock
  ...
  $query = mysqli_query($db,"UPDATE suppliers SET suppliers_id='$suppliers_id', suppliers_name='$suppliers_name', stock_brand='$stock_brand'");
