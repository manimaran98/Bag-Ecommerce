...
<div class="container py-4">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        ...
        <form method="get" action="{{ route('products.index') }}" class="d-flex align-items-center gap-2">
            ...
            <select class="form-select form-select-sm" name="search" id="search" onchange="this.form.submit()">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm">
                    ...
                    <div class="card-body d-flex flex-column">
                        <h2 class="h5 card-title">{{ $p->stock_name }}</h2>
                        ...
                        <a class="btn btn-outline-primary mt-2" href="{{ route('products.show', $p) }}">Details</a>
                    </div>
                </div>
            </div>
        @empty
